System.register(['aurelia-framework', './aurelia-debugger.css!'], function (_export) {
	'use strict';

	var noView, inject, ViewResources, AureliaDebugger;
	...
	return {
		...
		}, function (_aureliaDebuggerCss) {}],
		execute: function () {
			AureliaDebugger = (function () {
				...
				AureliaDebugger = inject(ViewResources)(AureliaDebugger) || AureliaDebugger;
				AureliaDebugger = noView()(AureliaDebugger) || AureliaDebugger;
				return AureliaDebugger;
			})();

			_export('AureliaDebugger', AureliaDebugger);
		}
	};
});